...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₱{{number_format($annual, 2, '.', ' ')}}</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Most Requested Supply</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle d-none" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        @php $colors = ['#17a673', '#FBCF14', '#2c9faf', '#2e59d9', '#FBDF50']; @endphp
                                        @foreach($most_requested_supplies_description as $most_requested_supply_description)
                                            <span class="mr-2">
                                                <i class="fas fa-circle" style="color: {{ $colors[$loop->index] }}"></i> {{ $most_requested_supply_description }}
                                            </span>
                                        @endforeach
                                    </div>
                                </div>
    ...
    <script>
        ...
        let months = {!! $monthly_line_chart_months !!};
        let expenses = {!! $monthly_line_chart_expenses !!};
    ...
    <script>
        let most_requested_description = {!! $most_requested_supplies_description !!};
        let most_requested_total = {!! $most_requested_supplies_total !!};
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: most_requested_description,
                datasets: [{
                    data: most_requested_total,
                    backgroundColor: ['#1cc88a', '#FBDF50', '#36b9cc', '#4e73df', '#FBF87D'],
                    hoverBackgroundColor: ['#17a673', '#FBCF14', '#2c9faf', '#2e59d9', '#FBDF50'],
